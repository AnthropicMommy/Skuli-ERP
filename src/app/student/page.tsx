      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[var(--surface)] border border-border rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Link href="/student/revision-papers" className="flex items-center gap-2 p-3 rounded-lg border border-border hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)] transition-colors text-sm font-medium text-[var(--text-secondary)]">
              <svg className="w-4 h-4 text-[var(--text-primary)]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
