      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-6 text-center space-y-3">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <Link href="/student-login" className="inline-flex items-center justify-center h-9 px-4 rounded-lg border border-border text-xs font-medium text-[var(--text-secondary)] hover:bg-[var(--surface-hover)] hover:text-[var(--text-primary)] transition-all">
              Student Portal
            </Link>
          </div>
          <Link href="/" className="text-xs text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] block mt-4 transition-colors">
            Back to home
          </Link>
        </div>
      </div>
